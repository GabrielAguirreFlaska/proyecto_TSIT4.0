...
class Ui_CrearProducto(object):
    ...
    def retranslateUi(self, CrearProducto):
        ...
        self.input_id.setPlaceholderText(_translate("CrearProducto", "ID"))
        ...
        self.input_idinterprete.setPlaceholderText(_translate("CrearProducto", "ID intérprete"))
        self.label_5.setText(_translate("CrearProducto", "ID género:"))
        self.input_idgenero.setPlaceholderText(_translate("CrearProducto", "ID género"))
        ...
        self.input_iddiscografica.setPlaceholderText(_translate("CrearProducto", "ID discografica"))
